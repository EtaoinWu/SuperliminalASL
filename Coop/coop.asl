state("SuperliminalSteam", "coop")
{
  ...
  ulong levelInfo : "UnityPlayer.dll", 0x17C8588, 0x8, 0x1A0, 0x28, 0x50;
  ...
  uint EOLState : "UnityPlayer.dll", 0x17C8588, 0x8, 0x1A0, 0x28, 0x50, 0x10, 0x30, 0x30, 0x58, 0x28, 0x3c;
  // <some global object>.getComponent<GameManager>().player
  ulong player : "UnityPlayer.dll", 0x17C8588, 0x8, 0x60, 0x28, 0x28;
